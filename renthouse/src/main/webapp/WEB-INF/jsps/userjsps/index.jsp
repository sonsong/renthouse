...
<head>
    ...
    <link href="/renthouse/css/user/index.css" rel="stylesheet">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active slide_div">
                    <img class="img_slide" src="/renthouse/img/user/slide/slide_1.png" alt="...">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item slide_div">
                    <img class="img_slide" src="/renthouse/img/user/slide/slide_2.png" alt="...">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item slide_div">
                    <img class="img_slide" src="/renthouse/img/user/slide/slide_3.png" alt="...">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item slide_div">
                    <img class="img_slide" src="/renthouse/img/user/slide/slide_4.png" alt="...">
                    <div class="carousel-caption">
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid" style="margin-left: 60px">
        <div class="row">
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_1.jpg">
                <h4>原创设计</h4>
            </div>
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_2.jpg">
                <h4>高档家具</h4>
            </div>
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_3.jpg">
                <h4>环保装修</h4>
            </div>
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_4.jpg">
                <h4>极速Wi-Fi</h4>
            </div>
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_5.jpg">
                <h4>维修服务</h4>
            </div>
            <div class="col-sm-2 col-xs-4">
                <img src="/renthouse/img/user/propimg/adv_6.jpg">
                <h4>保洁服务</h4>
            </div>
        </div>
    </div>
