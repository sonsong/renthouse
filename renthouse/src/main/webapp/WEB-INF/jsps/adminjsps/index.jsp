...
<body>
	<div id="wrapper">
		...
		<!-- echarts js -->
		<script src="/renthouse/js/admin/echarts.min.js"></script>
	    ...
	    <script src="/renthouse/js/admin/table_contractIndex.js"></script>
		<script src="/renthouse/js/admin/table_billIndex.js"></script>
